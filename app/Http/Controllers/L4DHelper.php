...
class L4DHelper extends Controller
{
    ...
    public static $company_name = "LoadStop";
    ...
    public function curl_execute_remitbox($target, $keyword, $reference) {
      $username = Helper::Config("loadwallet_username");
      $password = Helper::Config("loadwallet_password");
      $authorization = base64_encode($username . ":" . $password);

      //api url
      $url = "https://api.loadwallet.com/reloads";
